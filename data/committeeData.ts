...
export const COMMITTEE_DIVISIONS: CommitteeDivision[] = [
  {
    ...
    fullDesc: 'Divisi Inti yang mengkoordinasikan seluruh divisi panitia, mengelola pendanaan umum, serta memastikan visi dan misi ASTRO 2026 tercapai secara maksimal.',
  ...
  },
  {
    ...
    fullDesc: 'Menyusun alur kegiatan, rulebook pertandingan akademik, olahraga, dan esports, serta berkoordinasi dengan juri profesional.',
  ...
  },
  {
    ...
    fullDesc: 'Menjalin kolaborasi strategis dengan berbagai brand, perusahaan, dan institusi untuk mensukseskan pendanaan dan hadiah peserta ASTRO 2026.',
  ...
  },
  {
    ...
    fullDesc: 'Mengelola customer service peserta, mengomunikasikan pengumuman penting, serta memajukan jangkauan publikasi ASTRO ke seluruh sekolah dan universitas.',
  ...
  },
  {
    ...
    fullDesc: 'Bertanggung jawab penuh terhadap estetika visual ASTRO 2026 mulai dari desain website, feed Instagram, liputan foto/video, hingga siaran langsung final.',
  ...
  },
  {
    ...
    fullDesc: 'Memastikan seluruh perangkat venue, studio esports, panggung awarding, serta jaringan listrik dan internet beroperasi tanpa kendala.',
  ...
  },
  {
    ...
    fullDesc: 'Menjamin ketersediaan konsumsi bernutrisi tepat waktu dan kesiapan fasilitas pertolongan pertama (P3K) di seluruh titik arena pertandingan.',
    ...
    leader: {
      ...
      image: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=800&auto=format&fit=crop&q=80',
      isLeader: true,
      quote: 'Kesehatan dan stamina panitia serta peserta adalah modal utama daya juang di lapangan.',
