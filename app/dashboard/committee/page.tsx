...
export default function CommitteePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showDivManager && (
        <div
          className="bg-white border border-slate-200 relative p-5 space-y-4"
          style={{
          ...
          <div className="flex gap-3 items-end">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setDivForm({ ...divForm, shortName: e.target.value })
                }
                placeholder="BPH"
                className={inp}
                style={{
            ...
            <div className="flex-1">
              ...
              <input
                value={divForm.slug}
                onChange={(e) =>
                  setDivForm({ ...divForm, slug: e.target.value })
                }
                placeholder="bph"
                className={inp}
                style={{
          ...
          <div className="flex flex-wrap gap-2">
            {divisions.map((d) => {
              ...
              return (
                <div
                  key={d.id}
                  className="flex items-center gap-2 px-3 py-1.5 bg-slate-50 border border-slate-200 text-xs font-bold text-slate-700"
                >
                  <span>{displayLabel}</span>
                  <button
                    onClick={() => handleDivEdit(d)}
                    className="text-slate-400 hover:text-astro-cyan cursor-pointer ml-1"
                  >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ketua Pelaksana / Staf"
                className={inp}
                style={{
                  clipPath:
                    "polygon(4px 0, 100% 0, calc(100% - 4px) 100%, 0 100%)",
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1">
                <button
                  type="button"
                  onClick={() => setForm({ ...form, isLeader: "1" })}
                ...
                <button
                  type="button"
                  onClick={() => setForm({ ...form, isLeader: "0" })}
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mt-1">
                <label className="cursor-pointer">
                  <div
                    className="px-4 py-2 bg-slate-100 border border-slate-200 hover:bg-slate-200 transition-colors text-xs font-bold text-slate-700 uppercase tracking-wider"
                    style={{
                      clipPath:
                        "polygon(5px 0, 100% 0, calc(100% - 5px) 100%, 0 100%)",
                    }}
      ...
      <div className="grid grid-cols-1 gap-3">
        {paginated.map((item) => (
          <div
            key={item.id}
            className="bg-white border border-slate-200 relative p-4 flex items-center justify-between group"
            style={{
              clipPath:
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex gap-2 mt-0.5">
                  ...
                  {item.isLeader === "1" && (
                    <span
                      className="text-[9px] font-bold uppercase text-amber-700 bg-amber-50 border border-amber-200 px-1.5 py-0.5"
                      style={{
                        clipPath:
            ...
            <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
              <button
                ...
                className="p-1.5 text-slate-400 hover:text-astro-cyan cursor-pointer"
              >
